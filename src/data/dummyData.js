export const departments = [
  ...
  {
    id: 2,
    name: "Department of Door Technology",
    description:
    ...
    imageAlt: "Modern architecture representing door engineering",
    email: "doors@monstersuniversity.edu",
    phone: "555-0199",
    location: "Innovation Hall",
  },
  {
    id: 3,
    name: "Scream Energy Research",
    description:
    ...
    imageAlt: "Research workspace representing scream energy studies",
    email: "energy@monstersuniversity.edu",
    phone: "555-0144",
    location: "Energy Research Center",
  },
  {
    id: 4,
    name: "Monster Business and Leadership",
    description:
    ...
    imageAlt: "Students collaborating in a business classroom",
    email: "business@monstersuniversity.edu",
    phone: "555-0188",
    location: "Roar Hall",
  },
];
